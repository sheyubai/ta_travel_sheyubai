<template>
  ...
  >
    <div class="wd-item-box" v-for="(wditem,i) in collectData.destinationDoubts" :key="i">
...
import { getMeCollection } from '~~/composables/api/questions';
...
const switchPage=(page)=>{
  getMeCollection({current:page,size:10}).then((res)=>{
     //console.log(res);
      collectData.destinationDoubts=res.data.records;
