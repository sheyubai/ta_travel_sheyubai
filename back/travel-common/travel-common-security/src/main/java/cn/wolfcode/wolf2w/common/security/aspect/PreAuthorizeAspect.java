...
public class PreAuthorizeAspect
{
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(cn.wolfcode.wolf2w.common.security.annotation.RequiresLogin) || "
            + "@annotation(cn.wolfcode.wolf2w.common.security.annotation.RequiresPermissions) || "
            + "@annotation(cn.wolfcode.wolf2w.common.security.annotation.RequiresRoles)";
