...
import cn.wolfcode.wolf2w.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered
{
    ...
    private Mono<Void> checkToken(String token, ServerWebExchange exchange, ServerHttpRequest.Builder mutate, GatewayFilterChain chain) {
